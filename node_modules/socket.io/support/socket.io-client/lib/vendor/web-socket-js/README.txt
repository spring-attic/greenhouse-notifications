...
Assuming you have Web server (e.g. Apache) running at https://example.com/ .

- Download web_socket.rb from:
  https://github.com/gimite/web-socket-ruby/tree/master
...
3. Make sure you do NOT open your HTML page as local file e.g. file:///.../sample.html. web-socket-js doesn't work on local file. Open it via Web server e.g. https:///.../sample.html.
...
https://github.com/LearnBoost/Socket.IO-node/blob/master/lib/socket.io/transports/flashsocket.js
...
The WebSocket spec (https://tools.ietf.org/html/draft-hixie-thewebsocketprotocol) specifies instructions for User Agents to support proxied connections by implementing the HTTP CONNECT method.
