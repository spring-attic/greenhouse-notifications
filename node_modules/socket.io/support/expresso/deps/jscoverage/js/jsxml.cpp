...
static const char xml_namespace_str[] = "https://www.w3.org/XML/1998/namespace";
static const char xmlns_namespace_str[] = "https://www.w3.org/2000/xmlns/";
...
GetNamespace(JSContext *cx, JSObject *qn, const JSXMLArray *inScopeNSes)
{
    ...
    if (inScopeNSes) {
        for (i = 0, n = inScopeNSes->length; i < n; i++) {
             ...
             * the https://www.w3.org/TR/xml-infoset/ spec, item 2.2.3, without
             ...
             * on t with argument {} U {(prefix="", uri="http://www.foo.com/")}.
...
GeneratePrefix(JSContext *cx, JSString *uri, JSXMLArray *decls)
{
     ...
     *
     *   var x = <f/>;
     *   var n = new Namespace("https://example.com/");
     *   x.@n::att = "val";
     *   x.toXMLString();
     *
