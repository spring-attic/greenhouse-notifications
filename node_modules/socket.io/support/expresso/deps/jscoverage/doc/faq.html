  ...
  <div id="bd">
    <div id="yui-main"> 
      <div id="jscoverage-main" class="yui-b">
        ...
        <h3>Can I use JSCoverage to measure code coverage for a page on <code>https://example.com/</code>?</h3>

        <p>
        In order to measure the code coverage of a page on <code>https://example.com/</code>,
        you must run <code>jscoverage</code> to create a <code>jscoverage.html</code> file on the
        <code>example.com</code> server.  You cannot use <code>https://example.org/jscoverage.html</code>
        to measure the code coverage of a page located on <code>https://example.com/</code>.
        </p>

        <p>
        The fundamental reason for this limitation is the
        <a href="https://www.mozilla.org/projects/security/components/same-origin.html">Same Origin Policy</a>
        ...
        href="https://tech.groups.yahoo.com/group/jsunit/message/1075">new
...
jscoverage src instrumented
        ...
        <p>
        See <a href="https://groups.google.com/group/Google-Web-Toolkit/browse_thread/thread/631908bd63241136/783c307480f95d8c">this discussion</a> for more information.
        </p>
        ...
        <h3 id="jsunit">Can JSCoverage be used with <a href="https://www.jsunit.net/">JsUnit</a>?</h3>
