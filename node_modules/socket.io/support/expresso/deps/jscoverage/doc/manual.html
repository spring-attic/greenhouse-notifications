...
Windows you will require <a href="https://cygwin.com/">Cygwin</a> or <a
...
by accessing the JSCoverage web interface at the special URL <code>https://example.com/jscoverage.html</code>.  
...
<pre>
jscoverage-server --proxy --no-instrument=https://example.com/scripts/
</pre>
