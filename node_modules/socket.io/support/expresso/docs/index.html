<html>
	...
	<body>
		<a href="https://github.com/visionmedia/expresso">
			<img alt="Fork me on GitHub" id="ribbon" src="https://s3.amazonaws.com/github/ribbons/forkme_right_white_ffffff.png" />
		</a>
		<div id="wrapper">
			<h1>Expresso</h1>
<div class='mp'>
...
<p><a href="https://github.com/visionmedia/expresso">Expresso</a> is a JavaScript <a href="https://en.wikipedia.org/wiki/Test-driven_development">TDD</a> framework written for <a href="https://nodejs.org">nodejs</a>. Expresso is extremely fast, and is packed with features such as additional assertion methods, code coverage reporting, CI support, and more.</p>
...
<li>test coverage support and reporting via <a href="https://github.com/visionmedia/node-jscoverage">node-jscoverage</a></li>
...
supports test coverage via <a href="https://github.com/visionmedia/node-jscoverage">node-jscoverage</a> (bundled with expresso),
so you will need to expose an instrumented version of you library.</p>

<p>To instrument your library, simply run <a href="https://github.com/visionmedia/node-jscoverage">node-jscoverage</a>,
...
<p><img src="https://dl.dropbox.com/u/6396913/cov.png" alt="node coverage" /></p>
