...
[Expresso](https://github.com/visionmedia/expresso) is a JavaScript [TDD](https://en.wikipedia.org/wiki/Test-driven_development) framework written for [nodejs](https://nodejs.org). Expresso is extremely fast, and is packed with features such as additional assertion methods, code coverage reporting, CI support, and more.
...
## Features
  ...
  - test coverage support and reporting via [node-jscoverage](https://github.com/visionmedia/node-jscoverage)
...
supports test coverage via [node-jscoverage](https://github.com/visionmedia/node-jscoverage) (bundled with expresso),
so you will need to expose an instrumented version of you library.

To instrument your library, simply run [node-jscoverage](https://github.com/visionmedia/node-jscoverage),
...
![node coverage](https://dl.dropbox.com/u/6396913/cov.png)
